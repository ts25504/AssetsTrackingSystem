...
<body background="images/bj.jpg">
	...
	<div id="container">
		...
		<div id="content">
			<form action="dep_modify.action" method="get">
				<table>
					...
					<tr>
						<td>depName:</td>
						<td><input name="depName" type="text" class="textfield"
							id="textfield"></td>
					</tr>
					<tr>
						<td>depLevel:</td>
						<td><input name="depLeavel" type="text" class="textfield"
							id="textfield2">
						</td>
					</tr>
					<tr>
						<td>depManager:</td>
						<td><input name="depManager" type="text" class="textfield"
							id="textfield3">
						</td>
					</tr>
