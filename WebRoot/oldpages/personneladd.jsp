...
<body background="images/bj.jpg">
	...
	<div id="container">
		...
		<div id="content">
			<form action="personnel_add.action" method="get">
				<table>
					<tr>
						<td>name:</td>
					...
					<tr>
						...
						<td><input name="personnelPwd" type="password"
							class="textfield" id="textfield2"></td>
					</tr>
					<tr>
						<td>sex:</td>
					...
					<tr>
						...
						<td><input name="personnelPositon" type="text"
							class="textfield" id="textfield4"></td>
					</tr>
					<tr>
						<td>phone:</td>
						<td><input name="personnelPhone" type="text"
							class="textfield" id="textfield5"></td>
					</tr>
					<tr>
						<td>pole</td>
