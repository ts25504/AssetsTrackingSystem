...
<body background="images/bj.jpg">
	...
	<div id="container">
		...
		<div id="content">
			<form action="assets_modify.action" method="get">
				<table>
					<tr>
						<td>id:</td>
					...
					<tr>
						<td>assetsName:</td>
						<td><input name="assetsName" type="text" class="textfield"
							id="textfield"></td>
					</tr>
					<tr>
						<td>assetsType:</td>
						<td><input name="assetsType" type="text" class="textfield"
							id="textfield2">
						</td>
					</tr>
					<tr>
						<td>assetsPrice:</td>
						<td><input name="assetsPrice" type="text" class="textfield"
							id="textfield3">
						</td>
					</tr>
					<tr>
						<td>assetsTime:</td>
						<td><input name="assetsTime" type="text" class="textfield"
							id="textfield4">
						</td>
					</tr>
					<tr>
						<td>assetsStatus:</td>
						<td><input name="assetsStatus" type="text" class="textfield"
							id="textfield5">
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td>personnel_id:</td>
						<td><input name="personnel_id" type="text" class="textfield"
							id="textfield7">
						</td>
					</tr>
					<tr>
						<td>pur_id:</td>
						<td><input name="pur_id" type="text" class="textfield"
							id="textfield7">
						</td>
					</tr>
					<tr>
