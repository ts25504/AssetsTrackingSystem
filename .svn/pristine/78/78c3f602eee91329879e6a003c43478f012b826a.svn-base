...
<body>
	...
	<div id="sidebar">
		...
		<ul>
			...
			<li class="active submenu open"><a href="#"><i class="icon icon-th-list"></i>
				...
				<ul>
					...
					<li><a href="personnelshow.jsp">查看人员</a></li>
				</ul></li>
				...
				<div class="span12">
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<form action="personnel_modify.action" method="get" class="form-horizontal">
							...
							<div class="control-group">
								<label class="control-label">个人密码：</label>
								<div class="controls">
									<input type="password" name="personnelPwd" />
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text"  name="personnelPositon"/>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">联系电话：</label>
								<div class="controls">
									<input type="text"  name="personnelPhone"/>
								</div>
							</div>
							<div class="control-group">
										<label class="control-label">人员角色：</label>
										<div class="controls">
											<select  name="personnelPole" >
