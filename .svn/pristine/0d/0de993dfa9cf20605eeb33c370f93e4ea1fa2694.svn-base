...
<body>
	...
	<div id="sidebar">
		...
		<ul>
			...
			<li class="active submenu open"><a href="#"><i class="icon icon icon-th"></i>
				...
				<div class="span12">
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<form action="purchase_modify.action" method="get" class="form-horizontal">
							...
							<div class="form-actions">
								<button type="submit" name="button" class="btn btn-primary">提交</button>
							</div>
							</form>
						</div>
					</div>
